...
for i in finished:
    ...
    score = 0
    if i['score_breakdown']['red']['rotor1Auto'] : score += 1
    if i['score_breakdown']['red']['rotor2Auto'] : score += 2
    ...
    score = 0
    if i['score_breakdown']['blue']['rotor1Auto'] : score += 1
    if i['score_breakdown']['blue']['rotor2Auto'] : score += 2
